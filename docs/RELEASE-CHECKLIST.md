...
5. للتجديد: أصدر مفتاحاً جديداً ويدخله العميل من «الإدارة ← الترخيص».
...
npm run dist:win
```
المثبّت في `release\ArabPowerTwin-Setup.exe`. أصدر لنفسك ترخيصاً تجريبياً بالأمر `issue` وفعّل البرنامج به.
